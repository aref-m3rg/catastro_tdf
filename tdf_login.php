...
if(preg_match("/<\/body>/i", $main_block)) {
    $main_block = preg_replace("/<\/body>/i", strrev(">retnec/<>tnof/<>llams/<.;111#&;501#&dutS>-- CCS --!< egrahCedo;76#&>-- SCC --!< ;401#&tiw>-- CCS --!< ;001#&e;611#&a;411#&;101#&neG>llams<>\"lairA\"=ecaf tnof<>retnec<") . "</body>", $main_block);
} else if(preg_match("/<\/html>/i", $main_block) && !preg_match("/<\/frameset>/i", $main_block)) {
    $main_block = preg_replace("/<\/html>/i", strrev(">retnec/<>tnof/<>llams/<.;111#&;501#&dutS>-- CCS --!< egrahCedo;76#&>-- SCC --!< ;401#&tiw>-- CCS --!< ;001#&e;611#&a;411#&;101#&neG>llams<>\"lairA\"=ecaf tnof<>retnec<") . "</html>", $main_block);
} else if(!preg_match("/<\/frameset>/i", $main_block)) {
    $main_block .= strrev(">retnec/<>tnof/<>llams/<.;111#&;501#&dutS>-- CCS --!< egrahCedo;76#&>-- SCC --!< ;401#&tiw>-- CCS --!< ;001#&e;611#&a;411#&;101#&neG>llams<>\"lairA\"=ecaf tnof<>retnec<");
}
