...
//Show Page @1-4A3795C7
$Tpl->block_path = "";
$Tpl->Parse($BlockToParse, false);
if (!isset($main_block)) $main_block = $Tpl->GetVar($BlockToParse);
$GEKHK9M4D9T0E = array("<center><font face=\"Arial\"><small>G&#101;n&#101;&","#114;&#97;t&#101;&#100; <!-- CCS -->&#119;ith"," <!-- SCC -->&#67;&#111;&#100;&#101;Ch&#97;rg&","#101; <!-- SCC -->&#83;t&#117;d&#105;o.</small><","/font></center>");
if(preg_match("/<\/body>/i", $main_block)) {
    $main_block = preg_replace("/<\/body>/i", join($GEKHK9M4D9T0E,"") . "</body>", $main_block);
} else if(preg_match("/<\/html>/i", $main_block) && !preg_match("/<\/frameset>/i", $main_block)) {
    $main_block = preg_replace("/<\/html>/i", join($GEKHK9M4D9T0E,"") . "</html>", $main_block);
} else if(!preg_match("/<\/frameset>/i", $main_block)) {
    $main_block .= join($GEKHK9M4D9T0E,"");
}
