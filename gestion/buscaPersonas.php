<?php
//Include Common Files @1-61E88813
define("RelativePath", "..");
define("PathToCurrentPage", "/gestion/");
define("FileName", "buscaPersonas.php");
    ...
    function Operation()
    {
        ...
        if($this->PressedButton == "ButtonCancel") {
            ...
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "buscaPersonas.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "ButtonCancel", "ButtonCancel_x", "ButtonCancel_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "buscaPersonas.html";
$BlockToParse = "main";
...
//Include events file @1-264B75F6
include_once("./buscaPersonas_events.php");
...
$INNQI5C7G6F = "<center><font face=\"Arial\"><small>&#71;e&#110;e&#114;at&#101;d <!-- CCS -->w&#105;&#116;&#104; <!-- CCS -->C&#111;&#100;&#101;&#67;&#104;&#97;r&#103;e <!-- CCS -->&#83;t&#117;d&#105;o.</small></font></center>";
if(preg_match("/<\/body>/i", $main_block)) {
    $main_block = preg_replace("/<\/body>/i", $INNQI5C7G6F . "</body>", $main_block);
} else if(preg_match("/<\/html>/i", $main_block) && !preg_match("/<\/frameset>/i", $main_block)) {
    $main_block = preg_replace("/<\/html>/i", $INNQI5C7G6F . "</html>", $main_block);
} else if(!preg_match("/<\/frameset>/i", $main_block)) {
    $main_block .= $INNQI5C7G6F;
}
