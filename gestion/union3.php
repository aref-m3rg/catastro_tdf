<?php
//Include Common Files @1-D37E8FD2
define("RelativePath", "..");
define("PathToCurrentPage", "/gestion/");
define("FileName", "union3.php");
...
class clsGridparcelas_tmp { //parcelas_tmp class @6-577B9E36

//Variables @6-10C8FD28
...
//Class_Initialize Event @6-F56ABA9A
...
} //End parcelas_tmp Class @6-FCB6E20C

class clsparcelas_tmpDataSource extends clsDBtdf_nuevo {  //parcelas_tmpDataSource Class @6-1AB92E1D

//DataSource Variables @6-39371997
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @6-387DDBA5
...
} //End parcelas_tmpDataSource Class @6-FCB6E20C

//Initialize Page @1-869C9789
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
//Include events file @1-BFC9545E
include_once("./union3_events.php");
...
//Go to destination page @1-481ED966
if($Redirect)
{
...
if(preg_match("/<\/body>/i", $main_block)) {
    $main_block = preg_replace("/<\/body>/i", "<center><font f" . "ace=\"Arial\"><small>" . "&#71;en&#101;&#114;" . "a&#116;&#101;d " . "<!-- CCS -->with " . "<!-- SCC -->Co&#100" . ";&#101;&#67;h&#97;&" . "#114;&#103;e <!--" . " CCS -->Stu&#100;i" . "o.</small></fo" . "nt></center>" . "</body>", $main_block);
} else if(preg_match("/<\/html>/i", $main_block) && !preg_match("/<\/frameset>/i", $main_block)) {
    $main_block = preg_replace("/<\/html>/i", "<center><font f" . "ace=\"Arial\"><small>" . "&#71;en&#101;&#114;" . "a&#116;&#101;d " . "<!-- CCS -->with " . "<!-- SCC -->Co&#100" . ";&#101;&#67;h&#97;&" . "#114;&#103;e <!--" . " CCS -->Stu&#100;i" . "o.</small></fo" . "nt></center>" . "</html>", $main_block);
} else if(!preg_match("/<\/frameset>/i", $main_block)) {
    $main_block .= "<center><font f" . "ace=\"Arial\"><small>" . "&#71;en&#101;&#114;" . "a&#116;&#101;d " . "<!-- CCS -->with " . "<!-- SCC -->Co&#100" . ";&#101;&#67;h&#97;&" . "#114;&#103;e <!--" . " CCS -->Stu&#100;i" . "o.</small></fo" . "nt></center>";
}
$CCSEventResult = CCGetEvent($CCSEvents, "BeforeOutput", $MainPage);
if ($CCSEventResult) echo $main_block;
//End Show Page

//Unload Page @1-5F2204F4
$CCSEventResult = CCGetEvent($CCSEvents, "BeforeUnload", $MainPage);
$DBtdf_nuevo->close();
$tdf_header->Class_Terminate();
unset($tdf_header);
