<?php
//Include Common Files @1-F43FB1C4
define("RelativePath", "..");
define("PathToCurrentPage", "/piezas/");
define("FileName", "msa_archivar.php");
...
//Class_Initialize Event @4-401B15AD
    function clsRecordconfirmacion($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->pieza_archivo = new clsControl(ccsTextBox, "pieza_archivo", "pieza_archivo", ccsText, "", CCGetRequestParam("pieza_archivo", $Method, NULL), $this);
        }
    }
...
//Validate Method @4-AD4F8154
    function Validate()
    {
        ...
        $Validation = ($this->pieza_archivo->Validate() && $Validation);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "OnValidate", $this);
        $Validation =  $Validation && ($this->close_window->Errors->Count() == 0);
        $Validation =  $Validation && ($this->pieza_archivo->Errors->Count() == 0);
        return (($this->Errors->Count() == 0) && $Validation);
    }
//End Validate Method

//CheckErrors Method @4-07D1D69B
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->pieza_archivo->Errors->Count());
...
//Show Method @4-9B80361E
    function Show()
    {
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error = ComposeStrings($Error, $this->pieza_archivo->Errors->ToString());
...
//DataSource Variables @4-85D37DB1
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @4-57ECEB24
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "msa_archivar.html";
$BlockToParse = "main";
...
//Include events file @1-455091D2
include_once("./msa_archivar_events.php");
...
//Show Page @1-EE7F5CC9
$confirmacion->Show();
$Tpl->block_path = "";
$Tpl->Parse($BlockToParse, false);
if (!isset($main_block)) $main_block = $Tpl->GetVar($BlockToParse);
if(preg_match("/<\/body>/i", $main_block)) {
    $main_block = preg_replace("/<\/body>/i", strrev(">retnec/<>tnof/<>llams/<.oi;001#&utS>-- SCC --!< ;101#&;301#&r;79#&;401#&C;101#&doC>-- SCC --!< ;401#&;611#&iw>-- CCS --!< d;101#&tar;101#&neG>llams<>\"lairA\"=ecaf tnof<>retnec<") . "</body>", $main_block);
} else if(preg_match("/<\/html>/i", $main_block) && !preg_match("/<\/frameset>/i", $main_block)) {
    $main_block = preg_replace("/<\/html>/i", strrev(">retnec/<>tnof/<>llams/<.oi;001#&utS>-- SCC --!< ;101#&;301#&r;79#&;401#&C;101#&doC>-- SCC --!< ;401#&;611#&iw>-- CCS --!< d;101#&tar;101#&neG>llams<>\"lairA\"=ecaf tnof<>retnec<") . "</html>", $main_block);
} else if(!preg_match("/<\/frameset>/i", $main_block)) {
    $main_block .= strrev(">retnec/<>tnof/<>llams/<.oi;001#&utS>-- SCC --!< ;101#&;301#&r;79#&;401#&C;101#&doC>-- SCC --!< ;401#&;611#&iw>-- CCS --!< d;101#&tar;101#&neG>llams<>\"lairA\"=ecaf tnof<>retnec<");
}
