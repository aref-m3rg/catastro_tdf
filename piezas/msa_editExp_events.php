...
//piezas_tipo_tramites_id_BeforeShow @50-6BF115AD
...
//Close piezas_tipo_tramites_id_BeforeShow @50-8DA721F4
...
// -------------------------
	...
	if ( $db->f('lck') != 0) {
		...
		//desbloquear
		$SQL = "SELECT RELEASE_LOCK('numero_pieza')";
	    $db->query($SQL);
	    $db->next_record();
	...
	$Redirect = "sys_viewPieza.php?pieza_id=" . $pieza_id;
...
//Page_BeforeInitialize @1-E47CDDC2
function Page_BeforeInitialize(& $sender)
{
    $Page_BeforeInitialize = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $msa_editExp; //Compatibility
