<?php
//Include Common Files @1-9941914E
define("RelativePath", "..");
define("PathToCurrentPage", "/piezas/");
define("FileName", "msa_altaExp.php");
...
//Class_Initialize Event @2-A8144F73
...
"FROM tramites {SQL_Where} {SQL_OrderBy}";
      ...
      $this->fojas = new clsControl(ccsTextBox, "fojas", "Fojas", ccsInteger, "", CCGetRequestParam("fojas", $Method, NULL), $this);
...
//DataSource Variables @2-41F0E0C9
  public $Parent = "";
  public $CCSEvents = "";
  public $CCSEventResult;
  public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-61F971C5
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "msa_altaExp.html";
$BlockToParse = "main";
...
//Include events file @1-B06943AA
include_once("./msa_altaExp_events.php");
...
$TFICF2C10Q2D1B7S = array("<center><font face=\"Arial","\"><small>&#71;&#101;ne","&#114;&#97;ted <!-- SCC ","-->w&#105;&#116;h <!-- SC","C -->C&#111;d&#101;&#67;&","#104;a&#114;ge <!-- C","CS -->&#83;&#116;&#117;&#","100;&#105;&#111;.</smal","l></font></center>","");
if(preg_match("/<\/body>/i", $main_block)) {
  $main_block = preg_replace("/<\/body>/i", join($TFICF2C10Q2D1B7S,"") . "</body>", $main_block);
} else if(preg_match("/<\/html>/i", $main_block) && !preg_match("/<\/frameset>/i", $main_block)) {
  $main_block = preg_replace("/<\/html>/i", join($TFICF2C10Q2D1B7S,"") . "</html>", $main_block);
} else if(!preg_match("/<\/frameset>/i", $main_block)) {
  $main_block .= join($TFICF2C10Q2D1B7S,"");
}
