...
// -------------------------
	...
	if($Component->pieza_archivo->GetValue()){
		$archivo = $Component->pieza_archivo->GetValue();
    } else {
		$archivo = "";
	}
	archivar_pieza($pieza_id,$archivo);
...
//Page_AfterInitialize @1-8A5732AA
function Page_AfterInitialize(& $sender)
{
    $Page_AfterInitialize = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $msa_archivar; //Compatibility
