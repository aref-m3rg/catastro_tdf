...
//piezas_tipo_tramites_id_BeforeShow @42-6BF115AD
...
//Close piezas_tipo_tramites_id_BeforeShow @42-8DA721F4
...
//Page_BeforeInitialize @1-751ABDD4
function Page_BeforeInitialize(& $sender)
{
  $Page_BeforeInitialize = true;
  $Component = & $sender;
  $Container = & CCGetParentContainer($sender);
  global $msa_altaExp; //Compatibility
