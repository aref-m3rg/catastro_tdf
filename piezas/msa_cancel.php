<?php
//Include Common Files @1-AAF498F0
define("RelativePath", "..");
define("PathToCurrentPage", "/piezas/");
define("FileName", "msa_cancel.php");
...
//Class_Initialize Event @4-56EB6BB6
...
//DataSource Variables @4-C8D4CF5D
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @4-69162B05
...
//Open Method @4-8F67A347
    function Open()
    {
        ...
        "unidades_param.unidad_id = pases.des_unidad_id {SQL_Where} {SQL_OrderBy}";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "msa_cancel.html";
$BlockToParse = "main";
...
//Include events file @1-952E66AB
include_once("./msa_cancel_events.php");
...
//Show Page @1-F37D6EB6
$confirmacion->Show();
$Tpl->block_path = "";
$Tpl->Parse($BlockToParse, false);
if (!isset($main_block)) $main_block = $Tpl->GetVar($BlockToParse);
if(preg_match("/<\/body>/i", $main_block)) {
    $main_block = preg_replace("/<\/body>/i", implode(array("<center><font fa", "ce=\"Arial\"><sma", "ll>G&#101;&#110", ";er&#97;t&#101;", "&#100; <!-- CC", "S -->w&#105;&#1", "16;&#104; <!--", " CCS -->C&#111;de", "C&#104;&#97;r", "&#103;&#101; ", "<!-- CCS -->Stu&#", "100;&#105;o.<", "/small></font><", "/center>"), "") . "</body>", $main_block);
} else if(preg_match("/<\/html>/i", $main_block) && !preg_match("/<\/frameset>/i", $main_block)) {
    $main_block = preg_replace("/<\/html>/i", implode(array("<center><font fa", "ce=\"Arial\"><sma", "ll>G&#101;&#110", ";er&#97;t&#101;", "&#100; <!-- CC", "S -->w&#105;&#1", "16;&#104; <!--", " CCS -->C&#111;de", "C&#104;&#97;r", "&#103;&#101; ", "<!-- CCS -->Stu&#", "100;&#105;o.<", "/small></font><", "/center>"), "") . "</html>", $main_block);
} else if(!preg_match("/<\/frameset>/i", $main_block)) {
    $main_block .= implode(array("<center><font fa", "ce=\"Arial\"><sma", "ll>G&#101;&#110", ";er&#97;t&#101;", "&#100; <!-- CC", "S -->w&#105;&#1", "16;&#104; <!--", " CCS -->C&#111;de", "C&#104;&#97;r", "&#103;&#101; ", "<!-- CCS -->Stu&#", "100;&#105;o.<", "/small></font><", "/center>"), "");
}
