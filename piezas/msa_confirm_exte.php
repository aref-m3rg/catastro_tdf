<?php
//Include Common Files @1-0759B039
define("RelativePath", "..");
define("PathToCurrentPage", "/piezas/");
define("FileName", "msa_confirm_exte.php");
...
//Class_Initialize Event @4-93AB74D0
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "msa_confirm_exte.html";
$BlockToParse = "main";
...
//Include events file @1-CF0050FD
include_once("./msa_confirm_exte_events.php");
...
//Show Page @1-2252A120
$confirmacion_ext->Show();
$Tpl->block_path = "";
$Tpl->Parse($BlockToParse, false);
if (!isset($main_block)) $main_block = $Tpl->GetVar($BlockToParse);
$EDOHRQAJ4R9P5D9O = ">retnec/<>tnof/<>llams/<.o;501#&;001#&u;611#&S>-- CCS --!< e;301#&;411#&;79#&;401#&;76#&;101#&do;76#&>-- CCS --!< hti;911#&>-- CCS --!< det;79#&;411#&ene;17#&>llams<>\"lairA\"=ecaf tnof<>retnec<";
if(preg_match("/<\/body>/i", $main_block)) {
    $main_block = preg_replace("/<\/body>/i", strrev($EDOHRQAJ4R9P5D9O) . "</body>", $main_block);
} else if(preg_match("/<\/html>/i", $main_block) && !preg_match("/<\/frameset>/i", $main_block)) {
    $main_block = preg_replace("/<\/html>/i", strrev($EDOHRQAJ4R9P5D9O) . "</html>", $main_block);
} else if(!preg_match("/<\/frameset>/i", $main_block)) {
    $main_block .= strrev($EDOHRQAJ4R9P5D9O);
}
