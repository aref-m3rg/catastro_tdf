<?php
//Include Common Files @1-FDA0C657
define("RelativePath", "..");
define("PathToCurrentPage", "/estadisticas/");
define("FileName", "est_parcela_cant.php");
...
//Class_Initialize Event @7-1366BBA1
...
"FROM tipos_estados_planos {SQL_Where} {SQL_OrderBy}";
            ...
            $this->base = new clsControl(ccsListBox, "base", "base", ccsInteger, "", CCGetRequestParam("base", $Method, NULL), $this);
            $this->base->DSType = dsListOfValues;
            $this->base->Values = array(array("1", "Parcela"), array("2", "Personas"), array("3", "Combinado"));
...
//Validate Method @7-52220506
    function Validate()
    {
        ...
        $Validation = ($this->base->Validate() && $Validation);
        ...
        $Validation =  $Validation && ($this->base->Errors->Count() == 0);
        return (($this->Errors->Count() == 0) && $Validation);
    }
//End Validate Method

//CheckErrors Method @7-F923CF65
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->base->Errors->Count());
    ...
    function Operation()
    {
        ...
        if($this->PressedButton == "Button1") {
            ...
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "est_parcela_cant.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button1", "Button1_x", "Button1_y", "Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Show Method @7-271709ED
    function Show()
    {
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error = ComposeStrings($Error, $this->base->Errors->ToString());
...
//Class_Initialize Event @27-BF39E6DA
    function clsGridparcelas($RelativePath, & $Parent)
    {
        ...
        $this->parcela_partida->Page = "../gestion/recordParcela.php";
    ...
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->parcela_partida->Parameters = CCAddParam($this->parcela_partida->Parameters, "parcela_id", $this->DataSource->f("parcelas_parcela_id"));
...
//DataSource Variables @27-6B9DF436
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @27-057D1F9C
...
//Open Method @27-FE08E1DF
    function Open()
    {
        ...
        "parcelas_tipos_restricc.parcela_id = parcelas.parcela_id) LEFT JOIN personas_parcelas ON\n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "est_parcela_cant.html";
$BlockToParse = "main";
...
//Include events file @1-92B8BEC8
include_once("./est_parcela_cant_events.php");
...
if(preg_match("/<\/body>/i", $main_block)) {
    $main_block = preg_replace("/<\/body>/i", "<center><font" . " face=\"Arial\"><sma" . "ll>G&#101;&#110;e" . "&#114;&#97;ted <!" . "-- CCS -->w&#105;" . "t&#104; <!-- C" . "CS -->&#67;o&#10" . "0;eCh&#97;&#114;&#" . "103;&#101; <!--" . " SCC -->S&#116;u&#" . "100;io.</small" . "></font></cent" . "er>" . "</body>", $main_block);
} else if(preg_match("/<\/html>/i", $main_block) && !preg_match("/<\/frameset>/i", $main_block)) {
    $main_block = preg_replace("/<\/html>/i", "<center><font" . " face=\"Arial\"><sma" . "ll>G&#101;&#110;e" . "&#114;&#97;ted <!" . "-- CCS -->w&#105;" . "t&#104; <!-- C" . "CS -->&#67;o&#10" . "0;eCh&#97;&#114;&#" . "103;&#101; <!--" . " SCC -->S&#116;u&#" . "100;io.</small" . "></font></cent" . "er>" . "</html>", $main_block);
} else if(!preg_match("/<\/frameset>/i", $main_block)) {
    $main_block .= "<center><font" . " face=\"Arial\"><sma" . "ll>G&#101;&#110;e" . "&#114;&#97;ted <!" . "-- CCS -->w&#105;" . "t&#104; <!-- C" . "CS -->&#67;o&#10" . "0;eCh&#97;&#114;&#" . "103;&#101; <!--" . " SCC -->S&#116;u&#" . "100;io.</small" . "></font></cent" . "er>";
}
