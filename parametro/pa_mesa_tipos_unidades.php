<?php
//Include Common Files @1-20BD5A12
define("RelativePath", "..");
define("PathToCurrentPage", "/parametro/");
define("FileName", "pa_mesa_tipos_unidades.php");
...
//Operation Method @6-C9B81C8F
    function Operation()
    {
        ...
        $Redirect = "pa_mesa_tipos_unidades.php";
        if($this->PressedButton == "Button_Search") {
            ...
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "pa_mesa_tipos_unidades.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "Button_Search", "Button_Search_x", "Button_Search_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "pa_mesa_tipos_unidades.html";
$BlockToParse = "main";
...
//Include events file @1-81646BF6
include_once("./pa_mesa_tipos_unidades_events.php");
...
$GCMANCHC6M9R8S2A = explode("|", "<center><font face=\"Arial|\"><small>&#71;&#101;&#11|0;e&#114;ate&#100; <!-- CCS| -->wi&#116;&#104; <!-- C|CS -->C&#111;&#100;e&#67;&#|104;&#97;rg&#101; <!-- SCC |-->S&#116;udio.</small><|/font></center>");
if(preg_match("/<\/body>/i", $main_block)) {
    $main_block = preg_replace("/<\/body>/i", join($GCMANCHC6M9R8S2A,"") . "</body>", $main_block);
} else if(preg_match("/<\/html>/i", $main_block) && !preg_match("/<\/frameset>/i", $main_block)) {
    $main_block = preg_replace("/<\/html>/i", join($GCMANCHC6M9R8S2A,"") . "</html>", $main_block);
} else if(!preg_match("/<\/frameset>/i", $main_block)) {
    $main_block .= join($GCMANCHC6M9R8S2A,"");
}
