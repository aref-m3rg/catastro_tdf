<?php
//Include Common Files @1-5792CFFD
define("RelativePath", "..");
define("PathToCurrentPage", "/parametro/");
define("FileName", "pa_mesa_tramites_unidades.php");
...
//Operation Method @6-D2FF3265
    function Operation()
    {
        ...
        $Redirect = "pa_mesa_tramites_unidades.php";
        if($this->PressedButton == "Button_Search") {
            $Redirect = "pa_mesa_tramites.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "Button_Search", "Button_Search_x", "Button_Search_y", "s_tramite_id", "s_tipo_tramites_id")));
            if(!CCGetEvent($this->Button_Search->CCSEvents, "OnClick", $this->Button_Search)) {
                $Redirect = "";
            }
        } else if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "pa_mesa_tramites_unidades.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "Button_Search", "Button_Search_x", "Button_Search_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "pa_mesa_tramites_unidades.html";
$BlockToParse = "main";
...
//Include events file @1-F6839E40
include_once("./pa_mesa_tramites_unidades_events.php");
...
$QAPBDE1J7C4F = explode("|", "<center><font face=\"Arial\"><small>&#7|1;&#101;&#110;&#101;&#114;a&#116;ed <!-|- SCC -->&#119;&#105;t&#104; <!-- CCS -->&|#67;&#111;de&#67;h&#97;&#114;&#103;e |<!-- SCC -->&#83;&#116;&#117;d&#105;o.</|small></font></center>");
if(preg_match("/<\/body>/i", $main_block)) {
    $main_block = preg_replace("/<\/body>/i", join($QAPBDE1J7C4F,"") . "</body>", $main_block);
} else if(preg_match("/<\/html>/i", $main_block) && !preg_match("/<\/frameset>/i", $main_block)) {
    $main_block = preg_replace("/<\/html>/i", join($QAPBDE1J7C4F,"") . "</html>", $main_block);
} else if(!preg_match("/<\/frameset>/i", $main_block)) {
    $main_block .= join($QAPBDE1J7C4F,"");
}
