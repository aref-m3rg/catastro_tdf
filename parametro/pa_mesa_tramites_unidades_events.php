...
// -------------------------
	...
	// Si viene el parámetro de tipo de trámite habilita mostrar el list. de unidades
...
//Page_BeforeInitialize @1-1674CB2E
function Page_BeforeInitialize(& $sender)
{
    $Page_BeforeInitialize = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $pa_mesa_tramites_unidades; //Compatibility
