<?php
//Include Common Files @1-5519E253
define("RelativePath", "..");
define("PathToCurrentPage", "/parametro/");
define("FileName", "pa_tipos_personas_percelas.php");
...
//Class_Initialize Event @2-B6AC5B2B
    function clsEditableGridtipos_personas_parcelas($RelativePath, & $Parent)
    {
        ...
        $this->tipo_persona_parcela_ppal = new clsControl(ccsTextBox, "tipo_persona_parcela_ppal", "Principal", ccsInteger, "", NULL, $this);
        $this->tipo_persona_parcela_ppal->Required = true;
...
//GetFormParameters Method @2-BB7925B0
    function GetFormParameters()
    {
        for($RowNumber = 1; $RowNumber <= $this->TotalRows; $RowNumber++)
        {
            ...
            $this->FormParameters["tipo_persona_parcela_ppal"][$RowNumber] = CCGetFromPost("tipo_persona_parcela_ppal_" . $RowNumber, NULL);
            $this->FormParameters["CheckBox_Delete"][$RowNumber] = CCGetFromPost("CheckBox_Delete_" . $RowNumber, NULL);
        }
    }
//End GetFormParameters Method

//Validate Method @2-A712F627
    function Validate()
    {
        $Validation = true;
        ...
        for($this->RowNumber = 1; $this->RowNumber <= $this->TotalRows; $this->RowNumber++)
        {
            ...
            $this->tipo_persona_parcela_ppal->SetText($this->FormParameters["tipo_persona_parcela_ppal"][$this->RowNumber], $this->RowNumber);
...
//ValidateRow Method @2-EF08A337
    function ValidateRow()
    {
        ...
        $errors = ComposeStrings($errors, $this->tipo_persona_parcela_ppal->Errors->ToString());
        $errors = ComposeStrings($errors, $this->CheckBox_Delete->Errors->ToString());
        $this->tipo_persona_parcela_descrip->Errors->Clear();
        $this->tipo_persona_parcela_abrev->Errors->Clear();
        $this->tipo_persona_parcela_ppal->Errors->Clear();
...
//CheckInsert Method @2-D3E13881
    function CheckInsert()
    {
        ...
        $filed = ($filed || (is_array($this->FormParameters["tipo_persona_parcela_ppal"][$this->RowNumber]) && count($this->FormParameters["tipo_persona_parcela_ppal"][$this->RowNumber])) || strlen($this->FormParameters["tipo_persona_parcela_ppal"][$this->RowNumber]));
        return $filed;
    }
...
//InsertRow Method @2-64B3181B
    function InsertRow()
    {
        ...
        $this->DataSource->tipo_persona_parcela_ppal->SetValue($this->tipo_persona_parcela_ppal->GetValue(true));
...
//Show Method @2-B0E61E65
    function Show()
    {
        ...
        $this->ControlsVisible["tipo_persona_parcela_ppal"] = $this->tipo_persona_parcela_ppal->Visible;
        ...
        if ($is_next_record || ($EmptyRowsLeft && $this->InsertAllowed)) {
            do {
                ...
                if (!($this->FormSubmitted) && $is_next_record) {
                    ...
                    $this->tipo_persona_parcela_ppal->SetValue($this->DataSource->tipo_persona_parcela_ppal->GetValue());
                    ...
                    $this->tipo_persona_parcela_ppal->SetText("");
                } else {
                    $this->tipo_persona_parcela_descrip->SetText($this->FormParameters["tipo_persona_parcela_descrip"][$this->RowNumber], $this->RowNumber);
                    $this->tipo_persona_parcela_abrev->SetText($this->FormParameters["tipo_persona_parcela_abrev"][$this->RowNumber], $this->RowNumber);
                    $this->tipo_persona_parcela_ppal->SetText($this->FormParameters["tipo_persona_parcela_ppal"][$this->RowNumber], $this->RowNumber);
                ...
                $this->tipo_persona_parcela_ppal->Show($this->RowNumber);
...
//DataSource Variables @2-E693A790
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
    ...
    public $tipo_persona_parcela_ppal;
    public $CheckBox_Delete;
//End DataSource Variables

//DataSourceClass_Initialize Event @2-6494DBF8
    function clstipos_personas_parcelasDataSource(& $Parent)
    {
        ...
        $this->tipo_persona_parcela_ppal = new clsField("tipo_persona_parcela_ppal", ccsInteger, "");
        ...
        $this->InsertFields["tipo_persona_parcela_ppal"] = array("Name" => "tipo_persona_parcela_ppal", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        ...
        $this->UpdateFields["tipo_persona_parcela_ppal"] = array("Name" => "tipo_persona_parcela_ppal", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
    }
...
//SetValues Method @2-034F7048
    function SetValues()
    {
        ...
        $this->tipo_persona_parcela_ppal->SetDBValue(trim($this->f("tipo_persona_parcela_ppal")));
    }
//End SetValues Method

//Insert Method @2-A45AB889
    function Insert()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        ...
        $this->InsertFields["tipo_persona_parcela_ppal"]["Value"] = $this->tipo_persona_parcela_ppal->GetDBValue(true);
...
//Update Method @2-152DAFC9
    function Update()
    {
        ...
        $this->UpdateFields["tipo_persona_parcela_ppal"]["Value"] = $this->tipo_persona_parcela_ppal->GetDBValue(true);
...
//Delete Method @2-4D804132
    function Delete()
    {
        ...
        $SelectWhere = $this->Where;
        $this->Where = "tipo_persona_parcela_id=" . $this->ToSQL($this->CachedColumns["tipo_persona_parcela_id"], ccsInteger);
        $this->SQL = "DELETE FROM tipos_personas_parcelas";
...
//Class_Initialize Event @3-D3377A12
    function clsRecordtipos_personas_parcelasSearch($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Page = "pa_tipos_personas_percelas.php";
...
//Operation Method @3-3C4BAA53
    function Operation()
    {
        ...
        $Redirect = "pa_tipos_personas_percelas.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "pa_tipos_personas_percelas.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "pa_tipos_personas_percelas.html";
$BlockToParse = "main";
...
//Show Page @1-EDDA77ED
$tipos_personas_parcelas->Show();
$tipos_personas_parcelasSearch->Show();
$Tpl->block_path = "";
$Tpl->Parse($BlockToParse, false);
if (!isset($main_block)) $main_block = $Tpl->GetVar($BlockToParse);
$KHSTB10G5J9I4B = "<center><font face=\"Arial\"><small>&#71;&#101;&#110;&#101;&#114;a&#116;&#101;&#100; <!-- SCC -->&#119;&#105;&#116;&#104; <!-- SCC -->C&#111;de&#67;h&#97;&#114;ge <!-- SCC -->S&#116;&#117;&#100;i&#111;.</small></font></center>";
if(preg_match("/<\/body>/i", $main_block)) {
    $main_block = preg_replace("/<\/body>/i", $KHSTB10G5J9I4B . "</body>", $main_block);
} else if(preg_match("/<\/html>/i", $main_block) && !preg_match("/<\/frameset>/i", $main_block)) {
    $main_block = preg_replace("/<\/html>/i", $KHSTB10G5J9I4B . "</html>", $main_block);
} else if(!preg_match("/<\/frameset>/i", $main_block)) {
    $main_block .= $KHSTB10G5J9I4B;
}
$CCSEventResult = CCGetEvent($CCSEvents, "BeforeOutput", $MainPage);
if ($CCSEventResult) echo $main_block;
//End Show Page

//Unload Page @1-426AC869
$CCSEventResult = CCGetEvent($CCSEvents, "BeforeUnload", $MainPage);
$DBtdf_nuevo->close();
unset($tipos_personas_parcelas);
unset($tipos_personas_parcelasSearch);
