<?php
//Include Common Files @1-7ED54A45
define("RelativePath", "..");
define("PathToCurrentPage", "/administracion/");
define("FileName", "recordTipos.php");
...
//Class_Initialize Event @12-CBBEB8F2
    function clsReporttipos_tramites1($RelativePath = "", & $Parent)
    {
        ...
        $this->ImageLink1->Page = "recordTiposUnidades.php";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "recordTipos.html";
$BlockToParse = "main";
...
//Include events file @1-528658E1
include_once("./recordTipos_events.php");
