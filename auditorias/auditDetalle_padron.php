...
//Include Common Files @1-02198B3A
define("RelativePath", "..");
define("PathToCurrentPage", "/auditorias/");
define("FileName", "auditDetalle_padron.php");
...
//Class_Initialize Event @2-2457A680
    function clsGridauditorias_detalle($RelativePath, & $Parent)
    {
        ...
        $this->Link1->Page = "auditorias_padron.php";
    }
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "auditDetalle_padron.html";
$BlockToParse = "main";
...
//Include events file @1-B6D9A2B0
include_once("./auditDetalle_padron_events.php");
...
$SDTQATK7G10D9P0F7S = explode("|", "<center><font face=\"|Arial\"><small>Ge&#1|10;&#101;ra&#11|6;&#101;d <!-- SCC |-->wi&#116;h <!-- S|CC -->C&#111;de&|#67;&#104;&#97;&#114|;g&#101; <!-- SC|C -->&#83;t&#117;&#|100;&#105;o.</sm|all></font></ce|nter>");
if(preg_match("/<\/body>/i", $main_block)) {
    $main_block = preg_replace("/<\/body>/i", join($SDTQATK7G10D9P0F7S,"") . "</body>", $main_block);
} else if(preg_match("/<\/html>/i", $main_block) && !preg_match("/<\/frameset>/i", $main_block)) {
    $main_block = preg_replace("/<\/html>/i", join($SDTQATK7G10D9P0F7S,"") . "</html>", $main_block);
} else if(!preg_match("/<\/frameset>/i", $main_block)) {
    $main_block .= join($SDTQATK7G10D9P0F7S,"");
}
