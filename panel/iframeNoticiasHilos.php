<?php
//Include Common Files @1-72086FD2
define("RelativePath", "..");
define("PathToCurrentPage", "/panel/");
define("FileName", "iframeNoticiasHilos.php");
...
//Class_Initialize Event @6-430C7C99
...
//SetOrder Method @6-651D7BC4
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "noti_hilo_fecha desc";
...
//Prepare Method @6-B9961E1C
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urlnoticia_id", ccsInteger, "", "", $this->Parameters["urlnoticia_id"], "", true);
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "noticias_hilos.noticia_id", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsInteger),true);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @6-A45D9FDF
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM (noticias_hilos INNER JOIN _usuarios ON\n\n" .
        "noticias_hilos.usuario_id = _usuarios.usuario_id) LEFT JOIN noticias_h_estados ON\n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "iframeNoticiasHilos.html";
$BlockToParse = "main";
...
//Include events file @1-7A37EB86
include_once("./iframeNoticiasHilos_events.php");
...
//Show Page @1-BFDC93D4
$usuarios_noticias_h_estad->Show();
$Tpl->block_path = "";
$Tpl->Parse($BlockToParse, false);
if (!isset($main_block)) $main_block = $Tpl->GetVar($BlockToParse);
if(preg_match("/<\/body>/i", $main_block)) {
    $main_block = preg_replace("/<\/body>/i", implode(array("<center><font fac", "e=\"Arial\"><smal", "l>&#71;&#101;n&", "#101;&#114;at&", "#101;d <!-- CCS -", "->&#119;&#105;", "th <!-- CCS ", "-->&#67;od&#101", ";&#67;har&#103;&#", "101; <!-- CCS ", "-->&#83;t&#11", "7;&#100;&#105;o.<", "/small></font></", "center>"), "") . "</body>", $main_block);
} else if(preg_match("/<\/html>/i", $main_block) && !preg_match("/<\/frameset>/i", $main_block)) {
    $main_block = preg_replace("/<\/html>/i", implode(array("<center><font fac", "e=\"Arial\"><smal", "l>&#71;&#101;n&", "#101;&#114;at&", "#101;d <!-- CCS -", "->&#119;&#105;", "th <!-- CCS ", "-->&#67;od&#101", ";&#67;har&#103;&#", "101; <!-- CCS ", "-->&#83;t&#11", "7;&#100;&#105;o.<", "/small></font></", "center>"), "") . "</html>", $main_block);
} else if(!preg_match("/<\/frameset>/i", $main_block)) {
    $main_block .= implode(array("<center><font fac", "e=\"Arial\"><smal", "l>&#71;&#101;n&", "#101;&#114;at&", "#101;d <!-- CCS -", "->&#119;&#105;", "th <!-- CCS ", "-->&#67;od&#101", ";&#67;har&#103;&#", "101; <!-- CCS ", "-->&#83;t&#11", "7;&#100;&#105;o.<", "/small></font></", "center>"), "");
}
