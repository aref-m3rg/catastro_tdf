<?php
//Include Common Files @1-CA277DB9
define("RelativePath", "..");
define("PathToCurrentPage", "/tecnica/");
define("FileName", "tc_planosRecord.php");
...
//Class_Initialize Event @5-87EC16BC
...
"FROM tipos_deptos_parcela {SQL_Where} {SQL_OrderBy}";
            ...
            $this->ImageLink1->Parameters = CCAddParam($this->ImageLink1->Parameters, "plano_id", CCGetFromGet("plano_id", NULL));
            $this->ImageLink1->Page = "tc_docGrid.php";
...
"FROM tipos_planos {SQL_Where} {SQL_OrderBy}";
            ...
            $this->Button_Archivar = new clsButton("Button_Archivar", $Method, $this);
            $this->Button_Anular = new clsButton("Button_Anular", $Method, $this);
            $this->Button_Suspender = new clsButton("Button_Suspender", $Method, $this);
            ...
            $this->Button_Vigencia = new clsButton("Button_Vigencia", $Method, $this);
            $this->Button_Editar = new clsButton("Button_Editar", $Method, $this);
            $this->Label1 = new clsControl(ccsLabel, "Label1", "Label1", ccsBoolean, array("Sí", "No", ""), CCGetRequestParam("Label1", $Method, NULL), $this);
            $this->Button_desarchivar = new clsButton("Button_desarchivar", $Method, $this);
            $this->baja_pura = new clsButton("baja_pura", $Method, $this);
            $this->Panel2->AddComponent("ImageLink1", $this->ImageLink1);
...
//Operation Method @5-51C4749C
    function Operation()
    {
        ...
        if($this->FormSubmitted) {
            ...
            } else if($this->Button_Archivar->Pressed) {
                $this->PressedButton = "Button_Archivar";
            } else if($this->Button_Anular->Pressed) {
                $this->PressedButton = "Button_Anular";
            } else if($this->Button_Suspender->Pressed) {
                $this->PressedButton = "Button_Suspender";
            } else if($this->Button_Vigencia->Pressed) {
                $this->PressedButton = "Button_Vigencia";
            } else if($this->Button_Editar->Pressed) {
                $this->PressedButton = "Button_Editar";
            } else if($this->Button_desarchivar->Pressed) {
                $this->PressedButton = "Button_desarchivar";
            } else if($this->baja_pura->Pressed) {
                $this->PressedButton = "baja_pura";
            }
        }
        $Redirect = $FileName . "?" . CCGetQueryString("QueryString", array("ccsForm"));
        if($this->PressedButton == "Button_Cancel") {
            $Redirect = "tc_planosGrid.php" . "?" . CCGetQueryString("QueryString", array("ccsForm", "plano_id", "parcelasPage", "ver"));
            if(!CCGetEvent($this->Button_Cancel->CCSEvents, "OnClick", $this->Button_Cancel)) {
                $Redirect = "";
            }
        } else if($this->PressedButton == "Button_desarchivar") {
            if(!CCGetEvent($this->Button_desarchivar->CCSEvents, "OnClick", $this->Button_desarchivar)) {
                $Redirect = "";
            }
        } else if($this->PressedButton == "baja_pura") {
            if(!CCGetEvent($this->baja_pura->CCSEvents, "OnClick", $this->baja_pura)) {
                $Redirect = "";
            }
            ...
            if($this->PressedButton == "Button_Insert") {
                ...
                $Redirect = "tc_planosRegistro.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
                if(!CCGetEvent($this->Button_Registrar->CCSEvents, "OnClick", $this->Button_Registrar)) {
                    $Redirect = "";
                }
            } else if($this->PressedButton == "Button_Archivar") {
                if(!CCGetEvent($this->Button_Archivar->CCSEvents, "OnClick", $this->Button_Archivar)) {
                    $Redirect = "";
                }
            } else if($this->PressedButton == "Button_Anular") {
                if(!CCGetEvent($this->Button_Anular->CCSEvents, "OnClick", $this->Button_Anular)) {
                    $Redirect = "";
                }
            } else if($this->PressedButton == "Button_Suspender") {
                if(!CCGetEvent($this->Button_Suspender->CCSEvents, "OnClick", $this->Button_Suspender)) {
                    $Redirect = "";
                }
            } else if($this->PressedButton == "Button_Vigencia") {
                if(!CCGetEvent($this->Button_Vigencia->CCSEvents, "OnClick", $this->Button_Vigencia)) {
                    $Redirect = "";
                }
...
//DeleteRow Method @5-3ACD10A3
    function DeleteRow()
    {
        ...
        if($this->DataSource->Errors->Count() == 0) {
            $this->plano_archivo->Delete();
        }
        return (!$this->CheckErrors());
    }
//End DeleteRow Method

//Show Method @5-28D0D647
    function Show()
    {
        global $CCSUseAmp;
        global $Tpl;
        ...
        $this->Button_Archivar->Show();
        $this->Button_Anular->Show();
        $this->Button_Suspender->Show();
        $this->tipo_estado_plano_id->Show();
        $this->chk->Show();
        $this->plano_svc->Show();
        $this->plano_disposicion->Show();
        $this->CustomError->Show();
        $this->Button_Vigencia->Show();
        $this->Button_Editar->Show();
        $this->Label1->Show();
        $this->Button_desarchivar->Show();
        $this->baja_pura->Show();
        $Tpl->parse();
        $Tpl->block_path = $ParentPath;
        $this->DataSource->close();
...
//DataSource Variables @5-9A96EDCC
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @5-8F84440F
    function clsplanosDataSource(& $Parent)
    {
        ...
        $this->InsertFields["plano_e_nro"] = array("Name" => "plano_e_nro", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->InsertFields["plano_f_entrada"] = array("Name" => "plano_f_entrada", "Value" => "", "DataType" => ccsDate, "OmitIfEmpty" => 1);
        $this->InsertFields["plano_archivo"] = array("Name" => "plano_archivo", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["plano_e_letra"] = array("Name" => "plano_e_letra", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["plano_e_anio"] = array("Name" => "plano_e_anio", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->InsertFields["plano_observa"] = array("Name" => "plano_observa", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["plano_f_alta"] = array("Name" => "plano_f_alta", "Value" => "", "DataType" => ccsDate, "OmitIfEmpty" => 1);
        $this->InsertFields["plano_f_archivo"] = array("Name" => "plano_f_archivo", "Value" => "", "DataType" => ccsDate, "OmitIfEmpty" => 1);
        $this->InsertFields["plano_f_inicio"] = array("Name" => "plano_f_inicio", "Value" => "", "DataType" => ccsDate, "OmitIfEmpty" => 1);
        $this->InsertFields["plano_f_salida"] = array("Name" => "plano_f_salida", "Value" => "", "DataType" => ccsDate, "OmitIfEmpty" => 1);
        $this->InsertFields["profesional_id"] = array("Name" => "profesional_id", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->InsertFields["profesional_id_2"] = array("Name" => "profesional_id_2", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->InsertFields["tipo_plano_id"] = array("Name" => "tipo_plano_id", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->InsertFields["plano_anio"] = array("Name" => "plano_anio", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->InsertFields["plano_nro"] = array("Name" => "plano_nro", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->InsertFields["plano_f_registro"] = array("Name" => "plano_f_registro", "Value" => "", "DataType" => ccsDate, "OmitIfEmpty" => 1);
        $this->InsertFields["tipo_estado_plano_id"] = array("Name" => "tipo_estado_plano_id", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["plano_sin_origen"] = array("Name" => "plano_sin_origen", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->InsertFields["plano_svc"] = array("Name" => "plano_svc", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->InsertFields["plano_disposicion"] = array("Name" => "plano_disposicion", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
...
//SetValues Method @5-D9663C92
    function SetValues()
    {
        ...
        $this->Label1->SetDBValue(trim($this->f("plano_en_edicion")));
    }
//End SetValues Method

//Insert Method @5-25E40923
    function Insert()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        ...
        $this->InsertFields["plano_e_nro"]["Value"] = $this->plano_e_nro->GetDBValue(true);
        $this->InsertFields["plano_f_entrada"]["Value"] = $this->plano_f_entrada->GetDBValue(true);
        $this->InsertFields["plano_archivo"]["Value"] = $this->plano_archivo->GetDBValue(true);
        $this->InsertFields["plano_e_letra"]["Value"] = $this->plano_e_letra->GetDBValue(true);
        $this->InsertFields["plano_e_anio"]["Value"] = $this->plano_e_anio->GetDBValue(true);
        $this->InsertFields["plano_observa"]["Value"] = $this->plano_observa->GetDBValue(true);
        $this->InsertFields["plano_f_alta"]["Value"] = $this->plano_f_alta->GetDBValue(true);
        $this->InsertFields["plano_f_archivo"]["Value"] = $this->plano_f_archivo->GetDBValue(true);
        $this->InsertFields["plano_f_inicio"]["Value"] = $this->plano_f_inicio->GetDBValue(true);
        $this->InsertFields["plano_f_salida"]["Value"] = $this->plano_f_salida->GetDBValue(true);
        $this->InsertFields["profesional_id"]["Value"] = $this->prof_id->GetDBValue(true);
        $this->InsertFields["profesional_id_2"]["Value"] = $this->prof_id_2->GetDBValue(true);
        $this->InsertFields["tipo_plano_id"]["Value"] = $this->tipo_plano_id->GetDBValue(true);
        $this->InsertFields["plano_anio"]["Value"] = $this->plano_anio->GetDBValue(true);
        $this->InsertFields["plano_nro"]["Value"] = $this->plano_nro->GetDBValue(true);
        $this->InsertFields["plano_f_registro"]["Value"] = $this->plano_f_registro->GetDBValue(true);
        $this->InsertFields["tipo_estado_plano_id"]["Value"] = $this->tipo_estado_plano_id->GetDBValue(true);
        $this->InsertFields["plano_sin_origen"]["Value"] = $this->chk->GetDBValue(true);
        $this->InsertFields["plano_svc"]["Value"] = $this->plano_svc->GetDBValue(true);
        $this->InsertFields["plano_disposicion"]["Value"] = $this->plano_disposicion->GetDBValue(true);
        $this->SQL = CCBuildInsert("planos", $this->InsertFields, $this);
...
//Delete Method @5-E99804D3
    function Delete()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->CmdExecution = true;
        $this->cp["plano_id"] = new clsSQLParameter("urlplano_id", ccsInteger, "", "", CCGetFromGet("plano_id", NULL), 0, false, $this->ErrorBlock);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildDelete", $this->Parent);
        if (!is_null($this->cp["plano_id"]->GetValue()) and !strlen($this->cp["plano_id"]->GetText()) and !is_bool($this->cp["plano_id"]->GetValue())) 
            $this->cp["plano_id"]->SetText(CCGetFromGet("plano_id", NULL));
        if (!strlen($this->cp["plano_id"]->GetText()) and !is_bool($this->cp["plano_id"]->GetValue(true))) 
            $this->cp["plano_id"]->SetText(0);
        $this->SQL = "select 1";
...
//Class_Initialize Event @331-E64BFA68
...
//Initialize Method @331-01E055C5
    function Initialize()
    {
        if(!$this->Visible) return;
        ...
        $this->DataSource->Parameters["urlplano_id"] = CCGetFromGet("plano_id", NULL);
        $this->DataSource->Parameters["expr389"] = origen;
    }
//End Initialize Method
...
//UpdateGrid Method @331-FAA0E0D2
    function UpdateGrid()
    {
...
//SetFormState Method @331-D5E2CD2B
    function SetFormState($FormState)
    {
        if(strlen($FormState)) {
            ...
            $RowNumber = 0;
            for($i = 2; $i < sizeof($pieces); $i = $i + 12)  {
                $piece = $pieces[$i + 0];
...
//GetFormState Method @331-136D6ABE
    ...
    function Show()
    {
        ...
        if ($is_next_record || ($EmptyRowsLeft && $this->InsertAllowed)) {
            do {
                ...
                $this->Label2->Show($this->RowNumber);
                ...
                if ($is_next_record) {
                    if ($this->FormSubmitted) {
                        ...
                        if (($this->DataSource->CachedColumns["parcela_id"] == $this->CachedColumns["parcela_id"][$this->RowNumber]) && ($this->DataSource->CachedColumns["parcelas_org_id"] == $this->CachedColumns["parcelas_org_id"][$this->RowNumber]) && ($this->DataSource->CachedColumns["plano_id"] == $this->CachedColumns["plano_id"][$this->RowNumber]) && ($this->DataSource->CachedColumns["plano_tipo_id"] == $this->CachedColumns["plano_tipo_id"][$this->RowNumber]) && ($this->DataSource->CachedColumns["dpto_id"] == $this->CachedColumns["dpto_id"][$this->RowNumber]) && ($this->DataSource->CachedColumns["tipo_depto_parc_id"] == $this->CachedColumns["tipo_depto_parc_id"][$this->RowNumber]) && ($this->DataSource->CachedColumns["tipo_plano_id"] == $this->CachedColumns["tipo_plano_id"][$this->RowNumber]) && ($this->DataSource->CachedColumns["id"] == $this->CachedColumns["id"][$this->RowNumber]) && ($this->DataSource->CachedColumns["planos_prov_id"] == $this->CachedColumns["planos_prov_id"][$this->RowNumber]) && ($this->DataSource->CachedColumns["tipo_estado_id"] == $this->CachedColumns["tipo_estado_id"][$this->RowNumber]) && ($this->DataSource->CachedColumns["tipo_est_parc_id"] == $this->CachedColumns["tipo_est_parc_id"][$this->RowNumber]) && ($this->DataSource->CachedColumns["unidades_medidas_id"] == $this->CachedColumns["unidades_medidas_id"][$this->RowNumber])) {
...
//DataSource Variables @331-13DC1874
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @331-1183AB06
...
//Prepare Method @331-EC8A9999
    function Prepare()
    {
        ...
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urlplano_id", ccsInteger, "", "", $this->Parameters["urlplano_id"], "", false);
        $this->wp->AddParameter("2", "expr389", ccsText, "", "", $this->Parameters["expr389"], "", false);
        $this->AllParametersSet = $this->wp->AllParamsSet();
...
//Open Method @331-107FC808
    function Open()
    {
        ...
        "parcelas.tipo_est_parc_id = tipos_estados_parcela.tipo_est_parc_id) RIGHT JOIN unidades_medidas ON\n\n" .
        "unidades_medidas.unidades_medidas_id = parcelas.unidades_medidas_id";
        $this->SQL = "SELECT planos_parc_prov.*, parcelas.*, tipo_est_parc_descr, unidades_medidas_abrev \n\n" .
        "FROM ((parcelas INNER JOIN planos_parc_prov ON\n\n" .
        "planos_parc_prov.parcela_id = parcelas.parcela_id) LEFT JOIN tipos_estados_parcela ON\n\n" .
        "parcelas.tipo_est_parc_id = tipos_estados_parcela.tipo_est_parc_id) RIGHT JOIN unidades_medidas ON\n\n" .
        "unidades_medidas.unidades_medidas_id = parcelas.unidades_medidas_id {SQL_Where} {SQL_OrderBy}";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteSelect", $this->Parent);
        if ($this->CountSQL) 
...
//SetValues Method @331-C5078B79
    function SetValues()
    {
        ...
        $this->Label1->SetDBValue($this->f("parcela_super_mensura"));
        $this->Label2->SetDBValue($this->f("unidades_medidas_abrev"));
    }
//End SetValues Method
...
//Class_Initialize Event @86-A0151E74
    function clsGridparcelas_destino_prov($RelativePath, & $Parent)
    {
        ...
        $this->superficie = new clsControl(ccsLabel, "superficie", "superficie", ccsText, "", CCGetRequestParam("superficie", ccsGet, NULL), $this);
        ...
        $this->unidades_medidas_parcelas = new clsControl(ccsLabel, "unidades_medidas_parcelas", "unidades_medidas_parcelas", ccsText, "", CCGetRequestParam("unidades_medidas_parcelas", ccsGet, NULL), $this);
        $this->planos_prov_super_mensura = new clsControl(ccsHidden, "planos_prov_super_mensura", "planos_prov_super_mensura", ccsText, "", CCGetRequestParam("planos_prov_super_mensura", ccsGet, NULL), $this);
        ...
        $this->ImageLink1->Parameters = CCGetQueryString("QueryString", array("planos_prov_id", "ccsForm"));
        $this->ImageLink1->Parameters = CCAddParam($this->ImageLink1->Parameters, "plano_id", CCGetFromGet("plano_id", NULL));
        $this->ImageLink1->Page = "tc_addParcela.php";
        ...
        $this->ImageLink3->Parameters = CCGetQueryString("QueryString", array("planos_prov_id", "ccsForm"));
        $this->ImageLink3->Page = "tc_addVariasParcelas.php";
        $this->panel_destino->AddComponent("ImageLink1", $this->ImageLink1);
        $this->panel_destino->AddComponent("SeleccionarParcela", $this->SeleccionarParcela);
        $this->panel_destino->AddComponent("ImageLink3", $this->ImageLink3);
...
//Show Method @86-85A80410
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            $this->ControlsVisible["plano"] = $this->plano->Visible;
            $this->ControlsVisible["tipo_est_parc_descr"] = $this->tipo_est_parc_descr->Visible;
            $this->ControlsVisible["superficie"] = $this->superficie->Visible;
            $this->ControlsVisible["unidades_medidas_abrev"] = $this->unidades_medidas_abrev->Visible;
            $this->ControlsVisible["unidades_medidas_parcelas"] = $this->unidades_medidas_parcelas->Visible;
            $this->ControlsVisible["planos_prov_super_mensura"] = $this->planos_prov_super_mensura->Visible;
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->tipo_est_parc_descr->SetValue($this->DataSource->tipo_est_parc_descr->GetValue());
                $this->superficie->SetValue($this->DataSource->superficie->GetValue());
                $this->unidades_medidas_abrev->SetValue($this->DataSource->unidades_medidas_abrev->GetValue());
                $this->unidades_medidas_parcelas->SetValue($this->DataSource->unidades_medidas_parcelas->GetValue());
                $this->planos_prov_super_mensura->SetValue($this->DataSource->planos_prov_super_mensura->GetValue());
                $this->Attributes->SetValue("rowNumber", $this->RowNumber);
                $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeShowRow", $this);
                $this->Attributes->Show();
                ...
                $this->superficie->Show();
                $this->unidades_medidas_abrev->Show();
                $this->unidades_medidas_parcelas->Show();
                $this->planos_prov_super_mensura->Show();
                $Tpl->block_path = $ParentPath . "/" . $GridBlock;
                $Tpl->parse("Row", true);
            }
        }
...
//GetErrors Method @86-AA739978
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->superficie->Errors->ToString());
        $errors = ComposeStrings($errors, $this->unidades_medidas_abrev->Errors->ToString());
        $errors = ComposeStrings($errors, $this->unidades_medidas_parcelas->Errors->ToString());
        $errors = ComposeStrings($errors, $this->planos_prov_super_mensura->Errors->ToString());
...
//DataSource Variables @86-56C0DED1
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
    ...
    public $unidades_medidas_parcelas;
    public $planos_prov_super_mensura;
//End DataSource Variables

//DataSourceClass_Initialize Event @86-4A251109
    function clsparcelas_destino_provDataSource(& $Parent)
    {
        ...
        $this->superficie = new clsField("superficie", ccsText, "");
        
        $this->unidades_medidas_abrev = new clsField("unidades_medidas_abrev", ccsText, "");
        
        $this->unidades_medidas_parcelas = new clsField("unidades_medidas_parcelas", ccsText, "");
        
        $this->planos_prov_super_mensura = new clsField("planos_prov_super_mensura", ccsText, "");
...
//Open Method @86-DFF9E48C
    function Open()
    {
        ...
        "planos_parc_prov.parcela_id = parcelas.parcela_id) LEFT JOIN tipos_estados_parcela ON\n\n" .
        "parcelas.tipo_est_parc_id = tipos_estados_parcela.tipo_est_parc_id) LEFT JOIN unidades_medidas unidades_medidas1 ON\n\n" .
        "parcelas.unidades_medidas_id = unidades_medidas1.unidades_medidas_id) LEFT JOIN tipos_estados ON\n\n" .
        "planos_parc_prov.tipo_estado_id = tipos_estados.tipo_estado_id) LEFT JOIN unidades_medidas ON\n\n" .
        "planos_parc_prov.unidades_medidas_id = unidades_medidas.unidades_medidas_id";
        ...
        "parcelas.*, planos_prov_id, tipo_estado_descrip, tipo_est_parc_descr, planos_prov_super_mensura, unidades_medidas.unidades_medidas_abrev AS unidades_medidas_unidades_medidas_abrev,\n\n" .
        "unidades_medidas1.unidades_medidas_abrev AS unidades_medidas1_unidades_medidas_abrev \n\n" .
        "FROM ((((parcelas RIGHT JOIN planos_parc_prov ON\n\n" .
        "planos_parc_prov.parcela_id = parcelas.parcela_id) LEFT JOIN tipos_estados_parcela ON\n\n" .
        "parcelas.tipo_est_parc_id = tipos_estados_parcela.tipo_est_parc_id) LEFT JOIN unidades_medidas unidades_medidas1 ON\n\n" .
        "parcelas.unidades_medidas_id = unidades_medidas1.unidades_medidas_id) LEFT JOIN tipos_estados ON\n\n" .
        "planos_parc_prov.tipo_estado_id = tipos_estados.tipo_estado_id) LEFT JOIN unidades_medidas ON\n\n" .
        "planos_parc_prov.unidades_medidas_id = unidades_medidas.unidades_medidas_id {SQL_Where} {SQL_OrderBy}";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteSelect", $this->Parent);
        if ($this->CountSQL) 
            $this->RecordsCount = CCGetDBValue(CCBuildSQL($this->CountSQL, $this->Where, ""), $this);
        else
...
//SetValues Method @86-3484455C
    function SetValues()
    {
        ...
        $this->parcela_rte->SetDBValue($this->f("parcela_rte"));
        $this->tipo_est_parc_descr->SetDBValue($this->f("tipo_est_parc_descr"));
        $this->superficie->SetDBValue($this->f("parcela_super_mensura"));
        $this->unidades_medidas_abrev->SetDBValue($this->f("unidades_medidas_unidades_medidas_abrev"));
        $this->unidades_medidas_parcelas->SetDBValue($this->f("unidades_medidas1_unidades_medidas_abrev"));
        $this->planos_prov_super_mensura->SetDBValue($this->f("planos_prov_super_mensura"));
    }
//End SetValues Method
...
//Class_Initialize Event @437-D25CD13D
...
//Class_Initialize Event @541-C0E3D9C6
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "tc_planosRecord.html";
$BlockToParse = "main";
...
//Include events file @1-2CA415DE
include_once("./tc_planosRecord_events.php");
...
//Go to destination page @1-1EBFDADE
if($Redirect)
{
...
if(preg_match("/<\/body>/i", $main_block)) {
    $main_block = preg_replace("/<\/body>/i", implode(array("<center><font face=\"Aria", "l\"><small>&#71;&#101;&#11", "0;&#101;&#114;a&#116;ed <!--", " CCS -->wit&#104; <!-- CCS", " -->&#67;odeCh&#97;rge <!", "-- SCC -->St&#117;di&#111;.", "</small></font></center>"), "") . "</body>", $main_block);
} else if(preg_match("/<\/html>/i", $main_block) && !preg_match("/<\/frameset>/i", $main_block)) {
    $main_block = preg_replace("/<\/html>/i", implode(array("<center><font face=\"Aria", "l\"><small>&#71;&#101;&#11", "0;&#101;&#114;a&#116;ed <!--", " CCS -->wit&#104; <!-- CCS", " -->&#67;odeCh&#97;rge <!", "-- SCC -->St&#117;di&#111;.", "</small></font></center>"), "") . "</html>", $main_block);
} else if(!preg_match("/<\/frameset>/i", $main_block)) {
    $main_block .= implode(array("<center><font face=\"Aria", "l\"><small>&#71;&#101;&#11", "0;&#101;&#114;a&#116;ed <!--", " CCS -->wit&#104; <!-- CCS", " -->&#67;odeCh&#97;rge <!", "-- SCC -->St&#117;di&#111;.", "</small></font></center>"), "");
}
$CCSEventResult = CCGetEvent($CCSEvents, "BeforeOutput", $MainPage);
if ($CCSEventResult) echo $main_block;
//End Show Page

//Unload Page @1-2EDFF643
$CCSEventResult = CCGetEvent($CCSEvents, "BeforeUnload", $MainPage);
$DBtdf_nuevo->close();
$DBcatastro->close();
$tdf_header->Class_Terminate();
