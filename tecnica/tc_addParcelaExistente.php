<?php
//Include Common Files @1-849A6576
define("RelativePath", "..");
define("PathToCurrentPage", "/tecnica/");
define("FileName", "tc_addParcelaExistente.php");
...
//Class_Initialize Event @2-C28565BF
    function clsRecordparcelas($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->parcela_seccion = new clsControl(ccsLabel, "parcela_seccion", "Seccion", ccsText, "", CCGetRequestParam("parcela_seccion", $Method, NULL), $this);
            $this->parcela_macizo = new clsControl(ccsLabel, "parcela_macizo", "Macizo", ccsText, "", CCGetRequestParam("parcela_macizo", $Method, NULL), $this);
            $this->parcela_parcela = new clsControl(ccsLabel, "parcela_parcela", "Parcela", ccsText, "", CCGetRequestParam("parcela_parcela", $Method, NULL), $this);
            $this->parcela_chacra = new clsControl(ccsLabel, "parcela_chacra", "Chacra", ccsText, "", CCGetRequestParam("parcela_chacra", $Method, NULL), $this);
            $this->parcela_quinta = new clsControl(ccsLabel, "parcela_quinta", "Quinta", ccsText, "", CCGetRequestParam("parcela_quinta", $Method, NULL), $this);
            $this->parcela_fraccion = new clsControl(ccsLabel, "parcela_fraccion", "Fraccion", ccsText, "", CCGetRequestParam("parcela_fraccion", $Method, NULL), $this);
            $this->parcela_uf = new clsControl(ccsLabel, "parcela_uf", "Uf", ccsText, "", CCGetRequestParam("parcela_uf", $Method, NULL), $this);
            $this->parcela_predio = new clsControl(ccsLabel, "parcela_predio", "Predio", ccsText, "", CCGetRequestParam("parcela_predio", $Method, NULL), $this);
            $this->parcela_rte = new clsControl(ccsLabel, "parcela_rte", "Rte", ccsText, "", CCGetRequestParam("parcela_rte", $Method, NULL), $this);
            $this->parcela_superficie = new clsControl(ccsTextBox, "parcela_superficie", "Superficie de la Parcela", ccsFloat, array(False, 2, Null, "", False, "", "", 1, True, ""), CCGetRequestParam("parcela_superficie", $Method, NULL), $this);
            $this->parcela_superficie->Required = true;
            $this->parcela_porc_uf = new clsControl(ccsTextBox, "parcela_porc_uf", "Porcentaje UF", ccsFloat, array(False, 2, Null, "", False, "", "", 1, True, ""), CCGetRequestParam("parcela_porc_uf", $Method, NULL), $this);
            $this->parcela_sup_uf = new clsControl(ccsTextBox, "parcela_sup_uf", "Superficie propia de la UF", ccsFloat, array(False, 2, Null, "", False, "", "", 1, True, ""), CCGetRequestParam("parcela_sup_uf", $Method, NULL), $this);
            $this->uni_med_id = new clsControl(ccsListBox, "uni_med_id", "Unidades de medidas", ccsInteger, "", CCGetRequestParam("uni_med_id", $Method, NULL), $this);
...
//DataSource Variables @2-3D8BA09E
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-39ADC7C6
...
//Prepare Method @2-DDFA2240
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "planos_parc_prov.planos_prov_id", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsInteger),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @2-0D4E32B0
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT * \n\n" .
...
//Update Method @2-DBD994A4
    function Update()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->CmdExecution = true;
        $this->cp["parcela_superficie"] = new clsSQLParameter("ctrlparcela_superficie", ccsFloat, array(False, 2, Null, "", False, "", "", 1, True, ""), "", $this->parcela_superficie->GetValue(true), "", false, $this->ErrorBlock);
        $this->cp["parcela_porc_uf"] = new clsSQLParameter("ctrlparcela_porc_uf", ccsFloat, array(False, 2, Null, "", False, "", "", 1, True, ""), "", $this->parcela_porc_uf->GetValue(true), "", false, $this->ErrorBlock);
        $this->cp["parcela_sup_uf"] = new clsSQLParameter("ctrlparcela_sup_uf", ccsFloat, array(False, 2, Null, "", False, "", "", 1, True, ""), "", $this->parcela_sup_uf->GetValue(true), "", false, $this->ErrorBlock);
        $this->cp["uni_med_id"] = new clsSQLParameter("ctrluni_med_id", ccsInteger, "", "", $this->uni_med_id->GetValue(true), "", false, $this->ErrorBlock);
        $this->cp["planos_parc_prov_tipo"] = new clsSQLParameter("ctrlplanos_parc_prov_tipo", ccsText, "", "", $this->planos_parc_prov_tipo->GetValue(true), "", false, $this->ErrorBlock);
        $this->cp["planos_prov_id"] = new clsSQLParameter("urlplanos_prov_id", ccsInteger, "", "", CCGetFromGet("planos_prov_id", NULL), 0, false, $this->ErrorBlock);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildUpdate", $this->Parent);
        if (!is_null($this->cp["parcela_superficie"]->GetValue()) and !strlen($this->cp["parcela_superficie"]->GetText()) and !is_bool($this->cp["parcela_superficie"]->GetValue())) 
            $this->cp["parcela_superficie"]->SetValue($this->parcela_superficie->GetValue(true));
        if (!is_null($this->cp["parcela_porc_uf"]->GetValue()) and !strlen($this->cp["parcela_porc_uf"]->GetText()) and !is_bool($this->cp["parcela_porc_uf"]->GetValue())) 
            $this->cp["parcela_porc_uf"]->SetValue($this->parcela_porc_uf->GetValue(true));
        if (!is_null($this->cp["parcela_sup_uf"]->GetValue()) and !strlen($this->cp["parcela_sup_uf"]->GetText()) and !is_bool($this->cp["parcela_sup_uf"]->GetValue())) 
            $this->cp["parcela_sup_uf"]->SetValue($this->parcela_sup_uf->GetValue(true));
        if (!is_null($this->cp["uni_med_id"]->GetValue()) and !strlen($this->cp["uni_med_id"]->GetText()) and !is_bool($this->cp["uni_med_id"]->GetValue())) 
            $this->cp["uni_med_id"]->SetValue($this->uni_med_id->GetValue(true));
        if (!is_null($this->cp["planos_parc_prov_tipo"]->GetValue()) and !strlen($this->cp["planos_parc_prov_tipo"]->GetText()) and !is_bool($this->cp["planos_parc_prov_tipo"]->GetValue())) 
            $this->cp["planos_parc_prov_tipo"]->SetValue($this->planos_parc_prov_tipo->GetValue(true));
        if (!is_null($this->cp["planos_prov_id"]->GetValue()) and !strlen($this->cp["planos_prov_id"]->GetText()) and !is_bool($this->cp["planos_prov_id"]->GetValue())) 
            $this->cp["planos_prov_id"]->SetText(CCGetFromGet("planos_prov_id", NULL));
        if (!strlen($this->cp["planos_prov_id"]->GetText()) and !is_bool($this->cp["planos_prov_id"]->GetValue(true))) 
            $this->cp["planos_prov_id"]->SetText(0);
        $this->SQL = "UPDATE parcelas\n" .
        "INNER JOIN planos_parc_prov ON planos_parc_prov.parcela_id = parcelas.parcela_id\n" .
        "SET\n" .
        "  parcela_super_mensura = " . $this->SQLValue($this->cp["parcela_superficie"]->GetDBValue(), ccsFloat) . ",\n" .
        "  parcela_porc_uf = " . $this->SQLValue($this->cp["parcela_porc_uf"]->GetDBValue(), ccsFloat) . ",\n" .
        "  parcela_sup_uf = " . $this->SQLValue($this->cp["parcela_sup_uf"]->GetDBValue(), ccsFloat) . ",\n" .
        "  parcelas.unidades_medidas_id = " . $this->SQLValue($this->cp["uni_med_id"]->GetDBValue(), ccsInteger) . ",\n" .
        "  planos_parc_prov_tipo = '" . $this->SQLValue($this->cp["planos_parc_prov_tipo"]->GetDBValue(), ccsText) . "'\n" .
        "WHERE\n" .
        "  planos_parc_prov.planos_prov_id = " . $this->SQLValue($this->cp["planos_prov_id"]->GetDBValue(), ccsInteger) . "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "tc_addParcelaExistente.html";
$BlockToParse = "main";
...
//Include events file @1-9576F4A2
include_once("./tc_addParcelaExistente_events.php");
...
if(preg_match("/<\/body>/i", $main_block)) {
    $main_block = preg_replace("/<\/body>/i", implode(array("<center><font face", "=\"Arial\"><small", ">&#71;enera&#11", "6;e&#100; <!-- ", "SCC -->wi&#116;&#10", "4; <!-- CCS -->", "&#67;o&#100;&#1", "01;&#67;&#104;", "&#97;r&#103;&#", "101; <!-- CCS --", ">Studi&#111;.</smal", "l></font></center>"), "") . "</body>", $main_block);
} else if(preg_match("/<\/html>/i", $main_block) && !preg_match("/<\/frameset>/i", $main_block)) {
    $main_block = preg_replace("/<\/html>/i", implode(array("<center><font face", "=\"Arial\"><small", ">&#71;enera&#11", "6;e&#100; <!-- ", "SCC -->wi&#116;&#10", "4; <!-- CCS -->", "&#67;o&#100;&#1", "01;&#67;&#104;", "&#97;r&#103;&#", "101; <!-- CCS --", ">Studi&#111;.</smal", "l></font></center>"), "") . "</html>", $main_block);
} else if(!preg_match("/<\/frameset>/i", $main_block)) {
    $main_block .= implode(array("<center><font face", "=\"Arial\"><small", ">&#71;enera&#11", "6;e&#100; <!-- ", "SCC -->wi&#116;&#10", "4; <!-- CCS -->", "&#67;o&#100;&#1", "01;&#67;&#104;", "&#97;r&#103;&#", "101; <!-- CCS --", ">Studi&#111;.</smal", "l></font></center>"), "");
}
