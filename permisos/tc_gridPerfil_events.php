...
// -------------------------
	...
	if ( !empty( $perfilData ) ) {
		...
		$permissions_html .=	'<form action="' . RelativePath . '/permisos/tc_gridPerfil.php?perfil_id=' . $perfilData[0]['perfil_id'] . '&ccsForm=permisos_perfil" name="tipos_instrumentos" method="post" id="permisos_perfil">';
...
//Page_BeforeInitialize @1-5EF1F850
function Page_BeforeInitialize(& $sender)
{
    $Page_BeforeInitialize = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $tc_gridPerfil; //Compatibility
